...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 20, 2018 at 12:05 AM
...
CREATE TABLE `fabricas` (
  ...
  `f_pais` varchar(20) NOT NULL,
  `f_cant_empleados` int(11) NOT NULL
...
INSERT INTO `fabricas` (`id_fabrica`, `f_nombre`, `f_pais`, `f_cant_empleados`) VALUES
(1, 'chon-wan', 'china', 45),
(2, 'JFK', 'US', 45),
(3, 'umbakte', 'costa_de_marfil', 2253);
...
(5, 'pepe', 50, 3, '1995-03-14', 4),
(9, 'asd', 123, 3, '1995-02-14', 12);
